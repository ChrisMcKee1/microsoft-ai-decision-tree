...
title: Visual Frameworktitle: Visual Framework

nav_order: 10nav_order: 10

description: "Decision tree diagrams with Mermaid visualizations"description: "Decision tree diagrams with Mermaid visualizations"

------



# Visual Framework# Visual Framework
...
## Complete Decision Flow5. Test locally with undle exec jekyll serve
...
flowchart TD
    ...
    Start([Start: Need AI Solution]) --> Q1{Where should users<br/>experience the AI?}**Navigation:**

    - [← Back to Home](../README.md)

    Q1 -->|M365 apps| M365[M365 Copilot]- [View Technologies](technologies.md)

    Q1 -->|Teams, custom apps| Q2{Build style &<br/>control level?}- [View Decision Framework](decision-framework.md)
