...
- **Diagrams:** Mermaid flowcharts (embedded in Markdown)
- **Navigation:** Jekyll front matter with `nav_order` property
- **Styling:** Jekyll Just the Docs theme with custom SCSS
- **Deployment:** GitHub Pages (expected at https://chrismckee1.github.io/microsoft-ai-decision-tree/)
...
**Custom includes:**
- `_includes/head-custom.html` - Mermaid initialization
- `_includes/mermaid_config.js` - Mermaid dark theme config

**Configuration (_config.yml):**
- Theme: `just-the-docs`
- Mermaid integration via head-custom.html
